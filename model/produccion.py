...
class Produccionmodel:
    def __init__(self, cod_produccion,fecha_produccion, cantidad_produccion,cod_empleado,cod_material,cod_producto, cantidad_material ):
